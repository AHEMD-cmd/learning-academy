        ...
        <div class="row">
            <div class="col-lg-8 course_details_left">
                <div class="main_image">
                    <img class="img-fluid" src="{{asset('uploads/courses/'. $course->img)}}"   >
                </div>
                ...
                <div class="my-5">
                    ...
                    <form class="form-contact contact_form" action="{{route('front.message.enroll')}}" method="post" >
                        ...
                        <div class="row">
                          ...
                          <div class="col-12">
                            <div class="form-group">
                              <input class="form-control" name="spec" id="subject" type="text" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Enter spec'" placeholder = 'Enter Subject'>
                              @error('spec')
                              <div class="text-danger">{{$message}}</div>
                              @enderror
                            </div>
